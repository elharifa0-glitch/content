...
import {
  ...
  ListPlus, ClipboardList, Download, FileText, Scale,
} from "lucide-react";
...
export default function ContentStudio({ session, onSignOut }) {
  ...
  return (
    <div dir="rtl" style={S.app}>
      ...
      <main style={S.main} className="scrollbar">
        {view === "dashboard" && (
          <Dashboard
            brands={brands}
            items={items}
...
function Sidebar({ brands, view, setView, onAddBrand, saving, userEmail, onSignOut }) {
  return (
    <aside style={S.sidebar} className="scrollbar">
